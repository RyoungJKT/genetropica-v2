...
import type { Summary, Target, Drug, Field, DengueLiterature, BindingData, BindingIndex, Md, Conservation, Validation, Methods, Escape, Ns5Enrichment, Ns5EnrichmentCurrent } from './types'
...
export const useDengueLit = () => useQuery({ queryKey: ['dengueLit'], queryFn: () => json<DengueLiterature>('dengue_literature.json') })
